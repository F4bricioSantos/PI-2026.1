...
<body class="min-h-screen bg-[#f0f0f0] flex items-center justify-center px-4 py-12">
  ...
  <div class="w-full max-w-[440px]">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 px-6 py-8 sm:px-10 sm:py-10">
      ...
      <div id="etapa-2" class="hidden flex-col gap-5">
        ...
        <button id="btn-verificar-codigo" type="button"
          class="btn-primary w-full h-[52px] bg-orange-500 hover:bg-orange-600 text-white text-[15px] font-semibold rounded-lg
                 shadow-sm focus:outline-none focus:ring-4 focus:ring-orange-200 transition-all duration-200 flex items-center justify-center gap-2">
        ...
        <button id="btn-reenviar" type="button"
          class="text-[13px] text-orange-500 font-medium hover:text-orange-600 hover:underline transition-colors text-center w-full cursor-pointer">
          Reenviar código
        </button>
      </div>
      ...
      <div id="etapa-3" class="hidden flex-col gap-5">
        ...
        <button id="btn-redefinir" type="button"
          class="btn-primary w-full h-[52px] bg-orange-500 hover:bg-orange-600 text-white text-[15px] font-semibold rounded-lg
                 shadow-sm focus:outline-none focus:ring-4 focus:ring-orange-200 transition-all duration-200 flex items-center justify-center gap-2">
      ...
      <div id="etapa-sucesso" class="hidden flex-col items-center gap-5 text-center">
        ...
        <a href="login.php"
          class="w-full h-[52px] bg-orange-500 hover:bg-orange-600 text-white text-[15px] font-semibold rounded-lg
                 shadow-sm focus:outline-none focus:ring-4 focus:ring-orange-200 transition-all duration-200 flex items-center justify-center">
          Ir para o login
        </a>
      </div>
  ...
  <script>
    ...
    function irParaEtapa(n) {
      ...
      // Esconder link "voltar login" na tela de sucesso
      linkLogin.classList.toggle('hidden', n === 4);

      // Dots: 1=active 2,3=idle; depois vai atualizando
      dots.forEach((dot, i) => {
    ...
    async function enviarCodigo() {
      ...
      try {
        ...
        if (data.sucesso) {
          // Modo desenvolvimento: exibe o código em alerta
    ...
    // Enter em campos avança para próxima etapa
    ...
    // Auto-avança quando o código é preenchido
