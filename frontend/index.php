  ...
  <body class="font-sans text-gray-900 bg-white antialiased min-h-screen flex flex-col items-center">
    ...
    <div id="app" class="w-full max-w-[1440px] flex flex-col">
      ...
      <div id="mobile-menu" class="fixed inset-0 z-40 hidden md:hidden">
        ...
        <div class="absolute top-0 right-0 w-72 max-w-[85vw] h-full bg-white shadow-2xl p-6 flex flex-col gap-6">
      ...
      <main class="flex-1 flex flex-col items-center mt-6 md:mt-12 w-full">
        ...
        <div class="mt-20 sm:mt-24 mb-20 w-full flex flex-wrap items-center justify-center gap-10 sm:gap-16 md:gap-[120px] px-4">
          ...
          <div class="text-center">
            ...
            <p class="text-[11px] font-bold text-gray-400 uppercase tracking-[0.15em] whitespace-nowrap">Avaliação Média</p>
          </div>
          <div class="text-center">
            <p class="text-[28px] font-bold text-gray-500 leading-none mb-1.5">+50k</p>
            <p class="text-[11px] font-bold text-gray-400 uppercase tracking-[0.15em] whitespace-nowrap">Reformas Feitas</p>
          </div>
        </div>
        ...
        <section id="como-funciona" class="relative max-w-[1000px] w-full mb-28 px-4 flex flex-col items-center pt-24 -mt-24">
          ...
          <div class="mb-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-orange-50 text-orange-600 text-[13px] font-semibold border border-orange-100/50">Simples e Rápido</div>
          ...
          <div class="flex justify-center border-b border-gray-200 mb-12 w-full max-w-[400px]">
            <button id="tab-cliente" class="flex-1 text-center py-4 text-[15px] font-medium text-orange-500 border-b-2 border-orange-500 transition-colors">Sou cliente</button>
            <button id="tab-prestador" class="flex-1 text-center py-4 text-[15px] font-medium text-slate-400 hover:text-slate-900 border-b-2 border-transparent transition-colors">Sou prestador</button>
          </div>
          <div id="content-cliente" class="w-full grid grid-cols-1 md:grid-cols-3 gap-12 text-center relative">
            <div class="flex flex-col items-center z-10 px-2">
              <div class="w-14 h-14 rounded-2xl bg-orange-100 text-orange-600 flex items-center justify-center text-xl font-bold mb-6">1</div>
              <h4 class="text-[17px] font-bold text-slate-900 mb-3">Descreva o serviço</h4>
              <p class="text-[14px] text-gray-500 leading-relaxed max-w-[250px]">Diga o que você precisa e quando precisa.</p>
            </div>
            <div class="flex flex-col items-center z-10 px-2">
              <div class="w-14 h-14 rounded-2xl bg-orange-100 text-orange-600 flex items-center justify-center text-xl font-bold mb-6">2</div>
              <h4 class="text-[17px] font-bold text-slate-900 mb-3">Receba orçamentos</h4>
              <p class="text-[14px] text-gray-500 leading-relaxed max-w-[250px]">Até 4 profissionais qualificados entrarão em contato.</p>
            </div>
            <div class="flex flex-col items-center z-10 px-2">
              <div class="w-14 h-14 rounded-2xl bg-orange-100 text-orange-600 flex items-center justify-center text-xl font-bold mb-6">3</div>
              <h4 class="text-[17px] font-bold text-slate-900 mb-3">Escolha e avalie</h4>
              <p class="text-[14px] text-gray-500 leading-relaxed max-w-[250px]">Contrate o melhor custo-benefício e avalie o serviço.</p>
            </div>
          </div>
          <div id="content-prestador" class="hidden w-full grid grid-cols-1 md:grid-cols-3 gap-12 text-center relative">
            <div class="flex flex-col items-center z-10 px-2">
              <div class="w-14 h-14 rounded-2xl bg-amber-100 text-amber-600 flex items-center justify-center mb-6"><i data-lucide="image-plus" class="w-6 h-6"></i></div>
              <h4 class="text-[17px] font-bold text-slate-900 mb-3">Crie seu Portfólio</h4>
              <p class="text-[14px] text-gray-500 leading-relaxed max-w-[250px]">Inclua fotos de serviços prestados e mostre suas especialidades.</p>
            </div>
            <div class="flex flex-col items-center z-10 px-2">
              <div class="w-14 h-14 rounded-2xl bg-amber-100 text-amber-600 flex items-center justify-center mb-6"><i data-lucide="calculator" class="w-6 h-6"></i></div>
              <h4 class="text-[17px] font-bold text-slate-900 mb-3">Orçamentos Base</h4>
              <p class="text-[14px] text-gray-500 leading-relaxed max-w-[250px]">Defina tabelas de preços e estimativas para gerar confiança automática.</p>
            </div>
            <div class="flex flex-col items-center z-10 px-2">
              <div class="w-14 h-14 rounded-2xl bg-amber-100 text-amber-600 flex items-center justify-center mb-6"><i data-lucide="wallet" class="w-6 h-6"></i></div>
              <h4 class="text-[17px] font-bold text-slate-900 mb-3">Feche Negócios</h4>
              <p class="text-[14px] text-gray-500 leading-relaxed max-w-[250px]">Receba mensagens qualificadas no seu painel e negocie diretamente.</p>
            </div>
          </div>
        </section>
        ...
        <section id="categorias" class="relative w-full bg-white/60 backdrop-blur-xl rounded-[40px] p-8 md:p-12 mb-28 border border-white/80 shadow-[0_8px_40px_-12px_rgba(0,0,0,0.04)] pt-24 -mt-16 overflow-hidden">
          ...
          <div class="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-4 relative z-10">
            <div>
              <div class="mb-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-100/80 text-slate-600 text-[13px] font-semibold border border-slate-200/50">Catálogo Completo</div>
        ...
        <section id="avaliacoes" class="relative w-full mb-32 flex flex-col items-center pt-24 -mt-24 px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 w-full">
            <article class="bg-white/80 backdrop-blur-sm p-8 rounded-[28px] border border-gray-100 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.06)] hover:shadow-xl transition-all duration-300 flex flex-col h-full hover:-translate-y-1">
              ...
              <p class="text-[15px] text-gray-600 leading-relaxed mb-8 flex-1">"Encontrei um eletricista em menos de 1 hora. O serviço foi impecável e o preço justo. Recomendo muito!"</p>
              <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-orange-50 text-orange-600 flex items-center justify-center font-bold text-sm">RC</div>
                <div><p class="text-[14px] font-bold text-slate-900">Ricardo Costa</p><p class="text-[12px] text-gray-400">Cliente desde 2023</p></div>
              </div>
            </article>
            <article class="bg-white/80 backdrop-blur-sm p-8 rounded-[28px] border border-gray-100 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.06)] hover:shadow-xl transition-all duration-300 flex flex-col h-full hover:-translate-y-1">
              <div class="flex gap-[2px] text-orange-400 mb-6">
              ...
              <p class="text-[15px] text-gray-600 leading-relaxed mb-8 flex-1">"Plataforma muito organizada. Consegui comparar os orçamentos e escolher o que mais me passou segurança."</p>
              <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-orange-50 text-orange-600 flex items-center justify-center font-bold text-sm">AM</div>
                <div><p class="text-[14px] font-bold text-slate-900">Ana Martins</p><p class="text-[12px] text-gray-400">Cliente desde 2024</p></div>
              </div>
            </article>
            <article class="bg-white/80 backdrop-blur-sm p-8 rounded-[28px] border border-gray-100 shadow-[0_8px_30px_-12px_rgba(0,0,0,0.06)] hover:shadow-xl transition-all duration-300 flex flex-col h-full hover:-translate-y-1">
              <div class="flex gap-[2px] text-orange-400 mb-6">
              ...
              <p class="text-[15px] text-gray-600 leading-relaxed mb-8 flex-1">"Sou pintor e minha agenda lotou depois que entrei no ReformAí. O suporte deles é excelente."</p>
              <div class="flex items-center gap-3">
                <div class="w-10 h-10 rounded-full bg-orange-100 text-orange-700 flex items-center justify-center font-bold text-sm">JL</div>
                <div><p class="text-[14px] font-bold text-slate-900">Jorge Lima</p><p class="text-[12px] text-gray-400">Prestador verificado</p></div>
              </div>
            </article>
          </div>
        </section>
        ...
        <section class="w-full bg-gradient-to-br from-[#FF8C22] to-[#E95A0C] rounded-[32px] p-10 md:p-14 mb-24 flex flex-col md:flex-row items-center justify-between relative overflow-hidden shadow-[0_20px_40px_-15px_rgba(234,88,12,0.4)]">
          ...
          <div class="z-10 text-center md:text-left mb-8 md:mb-0 max-w-[600px] flex-1">
            <h2 class="text-[28px] md:text-[32px] font-bold text-white mb-3 tracking-tight">Você é profissional de reformas?</h2>
      ...
      <div class="w-full max-w-[1440px] px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16 px-2">
          <div class="flex flex-col">
            ...
            <p class="text-[14px] leading-[1.8] text-slate-400 max-w-[280px]">Conectando você aos melhores profissionais de reforma do Brasil de forma rápida e segura.</p>
          </div>
        ...
        <div class="border-t border-slate-800/60 pt-8 flex justify-center items-center">
          <p class="text-[13px] text-slate-500 text-center">© 2024 ReformAí Marketplace de Serviços. Todos os direitos reservados.</p>
        </div>
      </div>
    </footer>
    ...
    <script>
      ...
      document.getElementById('tab-cliente').addEventListener('click', () => {
        document.getElementById('content-cliente').classList.remove('hidden');
        document.getElementById('content-prestador').classList.add('hidden');
        document.getElementById('tab-cliente').classList.replace('text-slate-400','text-orange-500');
        document.getElementById('tab-cliente').classList.replace('border-transparent','border-orange-500');
        document.getElementById('tab-prestador').classList.replace('text-orange-500','text-slate-400');
        document.getElementById('tab-prestador').classList.replace('border-orange-500','border-transparent');
      });
      document.getElementById('tab-prestador').addEventListener('click', () => {
        document.getElementById('content-prestador').classList.remove('hidden');
        document.getElementById('content-cliente').classList.add('hidden');
        document.getElementById('tab-prestador').classList.replace('text-slate-400','text-orange-500');
        document.getElementById('tab-prestador').classList.replace('border-transparent','border-orange-500');
        document.getElementById('tab-cliente').classList.replace('text-orange-500','text-slate-400');
        document.getElementById('tab-cliente').classList.replace('border-orange-500','border-transparent');
      });
    </script>
